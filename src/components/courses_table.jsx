...
function CoursesTable() {
  ...
  const courses = [
    { sigla: 'INF-295', nombre: 'Inteligencia Artificial', postulantes: 4 },
    { sigla: 'INF-343', nombre: 'Sistemas Distribuidos', postulantes: 5 },
    { sigla: 'INF-285', nombre: 'Computación Científica', postulantes: 5 },
  ];
      ...
      <tbody className="table__body">
        {sortedCourses.map((course, index) => (
          <tr key={index}>
            ...
            <td><SeleccionarPostulante sigla={course.sigla} /></td>
          </tr>
        ))}
      </tbody>
    </table>
